// app/(admin)/admin/lessons/cancelled-snc/page.tsx
...
function readTier(rel: LessonRow["students"]): Tier {
  if (!rel) return null;
...
export default async function FreeSncPage({
  ...
  const { from, to, fromInput, toInput } = parseDateRange(searchParams);
  ...
  return (
    ...
    >
      ...
      <form method="GET" className="mb-4 flex flex-wrap items-end gap-3 text-xs">
