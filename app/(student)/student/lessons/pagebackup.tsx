...
import { formatDateTimeLondon, formatDeliveryLabel } from "@/lib/formatters";
...
export default async function StudentLessons({
  ...
  return (
    <Section title="Lessons" subtitle="Confirmed lessons for your account. It is likely to exclude lessons taken this month. ">
      {/* Filters */}
      <form
